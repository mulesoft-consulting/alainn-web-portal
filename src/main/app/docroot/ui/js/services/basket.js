...
'use strict';
	...
	var services = angular.module('alainn');
...
services.service('basketService', [ '$http', '$q', 'URLS', 'BasketItem', 'sessionService', '$rootScope', function ($http, $q, URLS, BasketItem, sessionService, $rootScope) {
    var basketService = 
    {
      _items: {},
